...
public class GameplayManager : MonoBehaviour {
	...
	void Start()
	{
		...
		GameObject.Find("LevelNameAndNumber").GetComponent<Text>().text =  LevelsParser.levelParser.packs[LevelsParser.selectedPack].ChildNodes[LevelsParser.selectedWorld].Attributes["title"].Value + " " + (LevelsParser.selectedLevel + 1).ToString();
